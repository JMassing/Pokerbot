...
namespace poker{
    ...
    { 
        ...
        if(this->money_tracker_.hasPlayerLessThanBigblind( this->settings_.big_blind) && this->data_.game_phase == HAND_CARDS)
        {
            this->controller_->stop();
        }
        ...
        if(this->detect_interface_ != nullptr && this->data_.game_phase > NOT_STARTED)
        {
           ...
           this->data_.probability = 
            ...
            //get bets
            if( this->data_.game_phase == BET_HAND || this->data_.game_phase == BET_FLOP 
                || this->data_.game_phase == BET_RIVER || this->data_.game_phase == BET_TURN)
            {   
                ...
                {
                    // Robot decides move if it is his turn and he hasn't decided and nobody raised 
                    ...
                    if ( this->data_.whos_turn == 0 
                         ...
                         && !this->getWinner())
                    {
                        DecisionMaker decision_maker(this->data_);
        ...
        else if(this->detect_interface_ == nullptr && this->data_.game_phase > NOT_STARTED)
        {
        ...
        if(this->gui_interface_ != nullptr)
        {
            ...
            this->data_.game_phase = this->data_.game_phase;
