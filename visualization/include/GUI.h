...
namespace visualization {
	...
	class GUI: public BaseGUI
	{
		private:
                  ...
                  void drawMainWindow(const std::pair<double,double>& probability, const std::vector<detect::Card>& robot_cards, const std::vector<detect::Card>& public_cards);
                  ...
                  void drawDeveloperWindow(int& live_threshold);

		public:

                  void GUI::drawGui(    const cv::Mat& frame, 
                                        const std::vector<detect::Card>& robot_cards, 
                                        const std::vector<detect::Card>& public_cards, 
                                        const std::pair<double,double>& probability,
                                        int& live_threshold);
		      ...
		      GUI():BaseGUI(), visualize_(), show_frame_(true), show_cards_(true), show_developer_window_(false),
                        ...
                        capture_train_img_(), threshold(0), mapping_() {};
			~GUI(){};
